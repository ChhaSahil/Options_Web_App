...
def plot(options_strategy,s,price,premium,K,options):
    if options_strategy=='Covered Call':
        ...
        if len(profit)!=0:
            ...
            plt.axhline(0,color = 'black', linestyle = '--',label='Breakeven')
            plt.axvline(S-premium,color = 'violet', linestyle = '--')
            plt.text(price[0],10,f"Breakeven : ₹{(S-premium):.2f}")
            plt.axhline(profit[-1], color = 'green', linestyle = '--', label = 'Maximum Profit')
            plt.text(price[0],profit[-1]+2,f"Max Profit : ₹{profit[-1]:.2f}",va="bottom",fontsize = 10)
        ...
        if len(profit)!=0:
            ...
            plt.axhline(profit[0], color = 'red', linestyle = '--', label = 'Maximum Loss')
            plt.text(price[0],profit[0]+2,f"Max Loss : ₹{profit[0]:.2f}",va="bottom",fontsize = 10)
            # plt.scatter(0,K,color = 'white')
            plt.legend()
            st.pyplot()
...
def plot2(options_strategy,K,K2,price,premium,premium2,options):
    if options_strategy=='Bull Call Spread':
        ...
        if len(profit)!=0:
            ...
            # plt.axvline(K,color = 'yellow', linestyle = '--', label = 'Strike Price')
            plt.axhline(profit[-1], color = 'green', linestyle = '--', label = 'Maximum Profit')
            plt.text(price[0],profit[-1]+2,f"Max Profit : ₹{profit[-1]:.2f}",fontsize = 10)
            plt.axhline(profit[0], color = 'red', linestyle = '--', label = 'Maximum Loss')
            plt.text(price[0],profit[0]+2,f"Max Loss : ₹{profit[0]:.2f}",va="bottom",fontsize = 10)
            plt.axvline(min(K,K2)+abs(premium-premium2),color = 'violet', linestyle = '--', label = 'Breakeven')
            plt.text(price[0],10,f"Breakeven Point : ₹{min(K,K2)+abs(premium-premium2):.2f}")
            # plt.scatter(0,K,color = 'white')
            # plt.legend()
            st.pyplot()
    if options_strategy=="Bear Put Spread":
        ...
        if len(profit)!=0:
            ...
            plt.plot(price,profit)
            plt.axhline(0,color = 'black', linestyle = '--')
            plt.axhline(profit[0], color = 'green', linestyle = '--', label = 'Maximum Profit')
            plt.text(price[0],profit[0]+2,f"Max Profit : ₹{profit[0]:.2f}",fontsize = 10)
            plt.axhline(profit[-1], color = 'red', linestyle = '--', label = 'Maximum Loss')
            plt.text(price[0],profit[-1]+2,f"Max Loss : ₹{profit[-1]:.2f}",va="bottom",fontsize = 10)
            plt.axvline(max(K,K2)-abs(premium-premium2),color = 'violet', linestyle = '--', label = 'Breakeven')
            plt.text(price[0],10,f"Breakeven Point : ₹{max(K,K2)-abs(premium-premium2):.2f}") 
            st.pyplot()
    ...
    if options_strategy=="Protective Collar":
        ...
        if len(profit)!=0:
            ...
            plt.axhline(profit[0], color = 'red', linestyle = '--', label = 'Maximum Loss')
            plt.text(price[0],profit[0]+2,f"Max Loss : ₹{profit[0]:.2f}",va="bottom",fontsize = 10)
            plt.axvline(S-(premium-premium2),color = 'violet', linestyle = '--', label = 'Breakeven')
            plt.text(price[0],10,f"Breakeven Point : ₹{S-(premium-premium2):.2f}")
            st.pyplot()
    if options_strategy=="Long Straddle":
        ...
        if len(profit)!=0:
            ...
            plt.plot(price,profit)
            plt.axhline(0,color = 'black', linestyle = '--')
            plt.axvline(K-(premium+premium2),color = 'violet', linestyle = '--', label = 'Breakeven')
            plt.text(price[0],10,f"Breakeven Point 1 : ₹{K-(premium+premium2):.2f}",fontsize=7)
            plt.axvline(K+(premium+premium2),color = 'violet', linestyle = '--', label = 'Breakeven')
            plt.text(price[-1]-10000,10,f"Breakeven Point 2 : ₹{K+(premium+premium2):.2f}",fontsize=7)
            plt.axhline(profit[profit.index(min(profit))], color = 'red', linestyle = '--', label = 'Maximum Loss')
            plt.text(price[0],profit[profit.index(min(profit))]+2,f"Max Loss : ₹{profit[profit.index(min(profit))]:.2f}",va="bottom",fontsize = 7)
            st.pyplot()
    ...
    if options_strategy=="Long Strangle":
        ...
        if len(profit)!=0:
            ...
            plt.plot(price,profit)
            plt.axhline(0,color = 'black', linestyle = '--')
            plt.axvline(K2-(premium+premium2),color = 'violet', linestyle = '--', label = 'Breakeven')
            plt.text(price[0],30,f"Breakeven Point 1 : ₹{K2-(premium+premium2):.2f}",fontsize=7)
            plt.axvline(K+(premium+premium2),color = 'violet', linestyle = '--', label = 'Breakeven')
            plt.text(price[-1]-3000,30,f"Breakeven Point 2 : ₹{K+(premium+premium2):.2f}",fontsize=7)
            plt.axhline(profit[profit.index(min(profit))], color = 'red', linestyle = '--', label = 'Maximum Loss')
            plt.text(price[0],profit[profit.index(min(profit))]+2,f"Max Loss : ₹{profit[profit.index(min(profit))]:.2f}",va="bottom",fontsize = 7)
...
def plot3(options_strategy,K,K2,K3,K4, price,premium,premium2,premium3,premium4,options):
    if options_strategy == "Long Call Butterfly Spread":
        ...
        if len(profit)!=0:
            ...
            plt.axhline(profit[profit.index(min(profit))], color = 'red', linestyle = '--', label = 'Maximum Loss')
            plt.text(price[0],profit[profit.index(min(profit))]+2,f"Max Loss : ₹{profit[profit.index(min(profit))]:.2f}",va="bottom",fontsize = 7)
            plt.axhline(profit[profit.index(max(profit))], color = 'green', linestyle = '--', label = 'Maximum Profit')
            plt.text(price[0],profit[profit.index(max(profit))]+2,f"Max Profit : ₹{profit[profit.index(max(profit))]:.2f}",va="bottom",fontsize = 7)
            plt.text(price[0],30,f"Breakeven Point 1 : ₹{-(-s[0][1]-s[-1][1]+s[1][1]+s[2][1])+s[0][0]:.2f}",fontsize=7)
            plt.axvline(-(-s[0][1]-s[-1][1]+s[1][1]+s[2][1])+s[0][0],color = 'violet', linestyle = '--', label = 'Breakeven')
            plt.axvline(s[-1][0]+(-s[0][1]-s[-1][1]+s[1][1]+s[2][1]),color = 'violet', linestyle = '--', label = 'Breakeven')
            plt.text(price[-1]-10000,10,f"Breakeven Point 2 : ₹{s[-1][0]+(-s[0][1]-s[-1][1]+s[1][1]+s[2][1]):.2f}",fontsize=7)
            st.pyplot()
...
def plot4(options_strategy,dic,price):
    if options_strategy=="Iron Condor":
        ...
        if len(profit)!=0:
            ...
            st.write(price)
            plt.plot(price,profit)
            plt.text(price[0],10,f"Breakeven Point 1 : ₹{max(put_s)-(max(put_p)+max(call_p)-min(call_p)-min(put_p)):.2f}",fontsize=7)
            plt.axvline(max(put_s)-(max(put_p)+max(call_p)-min(call_p)-min(put_p)),color = 'violet', linestyle = '--', label = 'Breakeven')
            plt.axvline((max(put_p)+max(call_p)-min(call_p)-min(put_p))+min(call_s),color = 'violet', linestyle = '--', label = 'Breakeven')
            plt.text(price[-1]-1500,10,f"Breakeven Point 2 : ₹{(max(put_p)+max(call_p)-min(call_p)-min(put_p))+min(call_s):.2f}",fontsize=7)
            plt.axhline(0,color = 'black', linestyle = '--',label='Breakeven')
            plt.axhline(profit[profit.index(max(profit))], color = 'green', linestyle = '--', label = 'Maximum Profit')
            plt.text(price[0],profit[profit.index(max(profit))]+2,f"Max Profit : ₹{profit[profit.index(max(profit))]:.2f}",va="bottom",fontsize = 7)
            plt.axhline(profit[profit.index(min(profit))], color = 'red', linestyle = '--', label = 'Maximum Loss')
